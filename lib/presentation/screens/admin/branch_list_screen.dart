...
final String _kScreenTitle = ScreenTitle.fromFile('branch_list_screen.dart');
...
class _BranchListScreenState extends State<BranchListScreen> {
  ...
  final Color _primaryColor = const Color(0xFF6F38C5);
  ...
  void _applyFilters(BranchProvider provider, int? companyId, bool? isMain) {
    provider.applyFilters(companyId: companyId, isMain: isMain);
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildTextField(
                              ...
                              errorText: codeError,
                              validator: (v) =>
                                  FormValidators.required(v, field: 'Branch code'),
                            ),
                            ...
                            _buildTextField(
                              ...
                              errorText: nameError,
                              validator: (v) =>
                                  FormValidators.required(v, field: 'Branch name'),
                            ),
                            const SizedBox(height: 15),
                            Container(
                              decoration: BoxDecoration(
                              ...
                              child: Padding(
                                ...
                                child: DropdownButtonFormField<int?>(
                                  ...
                                  validator: (v) =>
                                      FormValidators.dropdown(v, field: 'a company'),
