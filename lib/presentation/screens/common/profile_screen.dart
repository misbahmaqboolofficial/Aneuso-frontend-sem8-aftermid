...
final String _kScreenTitle = ScreenTitle.fromFile('profile_screen.dart');
        ...
        if (user == null) {
          return Scaffold(
            body: Center(
              child: Text(
                'No user data',
                style: TextStyle(fontSize: 18, color: Color(0xFF6F38C5)),
              ),
            ),
          );
        }
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildInfoItem(
                          ...
                          user.isActive ? Color(0xFF6F38C5) : Color(0xFF9B5DE0),
                        ),
                        _buildInfoItem(
                          'Email Verified',
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: _showPasswordFields
                                      ? Color(0xFF6F38C5).withOpacity(0.2)
