...
final String _kScreenTitle = ScreenTitle.fromFile('topic_detail_screen.dart');
...
class _TopicDetailScreenState extends State<TopicDetailScreen> {
  ...
  Widget _buildFilterChip(String label, String value, int count) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Color(0xFF6F38C5) : Colors.white,
          borderRadius: BorderRadius.circular(25),
          border: Border.all(
            color: isSelected ? Color(0xFF6F38C5) : Color(0xFFD78FEE),
            width: 2,
          ),
          boxShadow: [
            BoxShadow(
  ...
  Widget _buildVideoCard(BuildContext context, dynamic v, int index) {
    final colors = [
      [Color(0xFF6F38C5), Color(0xFF9B5DE0)],
      [Color(0xFF9B5DE0), Color(0xFFD78FEE)],
      [Color(0xFFD78FEE), Color(0xFFFDCFFA)],
      [Color(0xFF6F38C5), Color(0xFFD78FEE)],
    ];
